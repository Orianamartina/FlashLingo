...
import openpyxl
correct = 0
dict_file = openpyxl.load_workbook("Copia de Hoja de cálculo sin título - 14 de agosto, 15_40.xlsx")
word_list = dict_file["Hoja 1"]
def main():

    answer = input("HELLO! this is 1000 Words in German! \n"
    ...
    dict_making(501,601,words5)
    dict_making(601,701, words6)
    dict_making(701,801,words7)
    dict_making(801,901,words8)
    dict_making(901,1001,words9)
    ...
    def play_game(word_keys, word_dict, level):
        ...
        for keyword in word_keys:
            ...
            while userInputAnswer not in (word_dict[keyword]):
                ...
                if attepmts == 1:
                    print(keyword)
                    restart = input("You lost! do you want to try again? y/ to continue, n/ to exit!")
                    if restart == "y":
                        correct = 0
                        main()
                    else:
